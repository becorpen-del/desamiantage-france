...
const pagePath = "/prix-desamiantage-au-m2";
...
const breadcrumbLd = getBreadcrumbJsonLd([
  { name: "Accueil", path: "/" },
  { name: "Prix désamiantage au m²", path: pagePath },
]);
        ...
        <div className="mx-auto max-w-6xl space-y-16 px-6 py-12">
          ...
          <section className="space-y-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm">
              ...
              <p className="mt-2 text-slate-200">Ces exemples varient selon l&apos;accès, la complexité et la région.</p>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <p>Effet d&apos;échelle : les coûts fixes se diluent sur les grandes surfaces. Les tarifs unitaires diminuent lorsque la surface augmente.</p>
          </section>
          ...
          <section className="space-y-6">
            ...
            <p className="text-sm">Plus d&apos;exemples disponibles sur demande via le formulaire.</p>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <article className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm">
                ...
                <p className="mt-2">
                  Régions et communes subventionnent parfois le retrait (agricole, copro). ANAH pour profils modestes. Rapprochez-vous de votre
                  collectivité pour connaître les aides disponibles.
                </p>
              </article>
              <article className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm">
